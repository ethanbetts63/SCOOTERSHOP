...
class ServiceFAQCreateUpdateView(AdminRequiredMixin, View):
    """
    View to handle creating and updating Service FAQs.
    """
    ...
    def get(self, request, pk=None, *args, **kwargs):
        """
        Handles GET requests to display the form for creating or editing a Service FAQ.
        """
        if pk:
    ...
    def post(self, request, pk=None, *args, **kwargs):
        ...
        if form.is_valid():
            faq = form.save()
            if pk:
                messages.success(request, f"Service FAQ '{faq.question[:50]}...' updated successfully.")
            else:
                messages.success(request, f"Service FAQ '{faq.question[:50]}...' created successfully.")
