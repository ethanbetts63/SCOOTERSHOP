...
class TempServiceBooking(models.Model):
    ...
    dropoff_date = models.DateField(null=True, blank=True, help_text="Requested date for the drop off.")                
    dropoff_time = models.TimeField(null=True, blank=True, help_text="Requested drop-off time for the service.")                
