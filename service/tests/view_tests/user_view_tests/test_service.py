...
class ServiceViewTest(TestCase):
    ...
    @patch("service.views.user_views.service.get_service_date_availability")
    def test_get_service_view_service_types_load_error(
        self, mock_get_service_date_availability, mock_service_type_filter
    ):
        mock_get_service_date_availability.return_value = (datetime.date.today(), "[]")
    ...
    @patch("service.views.user_views.service.get_service_date_availability")
    def test_get_service_view_service_faqs_load_error(
        self, mock_get_service_date_availability, mock_service_faq_filter
    ):
        mock_get_service_date_availability.return_value = (datetime.date.today(), "[]")
    ...
    @patch("service.views.user_views.service.get_service_date_availability")
    def test_get_service_view_with_temp_booking_in_session(
        self, mock_get_service_date_availability
    ):
        mock_get_service_date_availability.return_value = (datetime.date.today(), "[]")
        temp_booking = TempServiceBookingFactory(
            service_type=self.service_type, service_date=datetime.date.today()
        )
        self.client.session["temp_service_booking_uuid"] = str(
        ...
        self.assertEqual(
            response.context["form"].initial["service_type"], self.service_type
        )
        self.assertEqual(
            response.context["form"].initial["service_date"], datetime.date.today()
        )

    @patch("service.views.user_views.service.get_service_date_availability")
    def test_get_service_view_with_invalid_temp_booking_uuid_in_session(
        self, mock_get_service_date_availability
    ):
        mock_get_service_date_availability.return_value = (datetime.date.today(), "[]")
