...
class ServiceBookingActionViewTest(TestCase):
    ...
    def test_get_confirm_action(self):
        response = self.client.get(reverse('service:admin_service_booking_action', kwargs={'pk': self.service_booking.pk, 'action_type': 'confirm'}))
    ...
    def test_get_reject_action(self):
        response = self.client.get(reverse('service:admin_service_booking_action', kwargs={'pk': self.service_booking.pk, 'action_type': 'reject'}))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'service/admin_service_booking_action.html')
    ...
    def test_dispatch_invalid_action(self):
        response = self.client.get(reverse('service:admin_service_booking_action', kwargs={'pk': self.service_booking.pk, 'action_type': 'invalid'}))
    ...
    def test_dispatch_nonexistent_booking(self):
        response = self.client.get(reverse('service:admin_service_booking_action', kwargs={'pk': 999, 'action_type': 'confirm'}))
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, reverse('service:service_booking_management'))

    @patch('service.views.admin_views.service_booking_action_view.confirm_service_booking')
    def test_post_confirm_action_success(self, mock_confirm):
        ...
        response = self.client.post(reverse('service:admin_service_booking_action', kwargs={'pk': self.service_booking.pk, 'action_type': 'confirm'}), data=form_data)
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, reverse('service:service_booking_management'))
    ...
    @patch('service.views.admin_views.service_booking_action_view.reject_service_booking')
    def test_post_reject_action_success(self, mock_reject):
        ...
        response = self.client.post(reverse('service:admin_service_booking_action', kwargs={'pk': self.service_booking.pk, 'action_type': 'reject'}), data=form_data)
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, reverse('service:service_booking_management'))
    ...
    def test_post_reject_action_with_refund_success(self, mock_reject):
        ...
        service_booking_with_deposit = ServiceBookingFactory(payment_status='deposit_paid', amount_paid=100.00)
        ...
        response = self.client.post(
            reverse('service:admin_service_booking_action', kwargs={'pk': service_booking_with_deposit.pk, 'action_type': 'reject'}),
            data=form_data
        )
