...
class ServiceAdminViewsPermissionsTestCase(TestCase):
    ...
    def test_service_booking_crud_permissions(self):
        ...
        self._test_url_permissions(
            "service:admin_service_booking_detail",
            kwargs={"pk": self.service_booking.pk},
        )
        self._test_url_permissions("service:admin_create_service_booking")
        self._test_url_permissions(
            "service:admin_edit_service_booking", kwargs={"pk": self.service_booking.pk}
        )
        self._test_url_permissions(
    ...
    def test_settings_and_blocked_dates_permissions(self):
        ...
        self._test_url_permissions(
            "service:delete_blocked_service_date",
    ...
    def test_service_brand_crud_permissions(self):
        ...
        self._test_url_permissions(
            "service:delete_service_brand",
            kwargs={"pk": self.service_brand.pk},
            method="post",
        )
    ...
    def test_service_type_crud_permissions(self):
        ...
        self._test_url_permissions(
            "service:edit_service_type", kwargs={"pk": self.service_type.pk}
        )
        self._test_url_permissions(
    ...
    def test_service_faq_crud_permissions(self):
        ...
        self._test_url_permissions(
            "service:service_faq_update", kwargs={"pk": self.faq.pk}
        )
        self._test_url_permissions(
            "service:service_faq_delete", kwargs={"pk": self.faq.pk}, method="post"
        )
    ...
    def test_service_profile_crud_permissions(self):
        ...
        self._test_url_permissions(
            "service:admin_edit_service_profile", kwargs={"pk": self.service_profile.pk}
        )
        self._test_url_permissions(
    ...
    def test_customer_motorcycle_crud_permissions(self):
        ...
        self._test_url_permissions(
            ...
            kwargs={"pk": self.customer_motorcycle.pk},
        )
        self._test_url_permissions(
