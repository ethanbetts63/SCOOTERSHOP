...
class ServicefaqModelTest(TestCase):
    ...
    def test_ordering(self):
        ...
        faq1 = ServicefaqFactory(
            booking_step="general", display_order=3, question="Question C"
        )
        faq2 = ServicefaqFactory(
            booking_step="step1", display_order=1, question="Question A"
        )
        faq3 = ServicefaqFactory(
            booking_step="general", display_order=2, question="Question B"
        )
    ...
    def test_booking_step_choices(self):
        ...
        self.assertIn(
            faq.booking_step, [choice[0] for choice in Servicefaq.BOOKING_STEP_CHOICES]
        )
