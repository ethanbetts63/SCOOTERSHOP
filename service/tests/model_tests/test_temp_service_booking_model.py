...
from service.tests.test_helpers.model_factories import ServiceBookingFactory, TempServiceBookingFactory, ServiceProfileFactory, ServiceTypeFactory, ServiceSettingsFactory, ServiceTermsFactory, ServicefaqFactory, CustomerMotorcycleFactory, BlockedServiceDateFactory, ServiceBrandFactory
...
class TempServiceBookingModelTest(TestCase):
    ...
    def test_required_fields_validation(self):
        ...
        try:
            ...
            self.fail(
                "ValidationError raised unexpectedly for nullable service_profile."
            )
    ...
    def test_payment_method_choices(self):
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for valid payment_method: {e.message_dict}"
            )
        ...
        self.assertIn(
            "Value 'invalid_option' is not a valid choice.", str(cm.exception)
        )
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for None payment_method: {e.message_dict}"
            )
    ...
    def test_dropoff_date_not_in_past(self):
        ...
        try:
            ...
            self.fail(
                "ValidationError raised for past dropoff_date, but model doesn't enforce this."
            )
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for current dropoff_date: {e.message_dict}"
            )
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for future dropoff_date: {e.message_dict}"
            )
    ...
    def test_calculated_deposit_amount_validation(self):
        ...
        try:
            ...
            self.fail(
                "ValidationError raised for negative calculated_deposit_amount, but model doesn't enforce this."
            )
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for zero calculated_deposit_amount: {e.message_dict}"
            )
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for positive calculated_deposit_amount: {e.message_dict}"
            )
        ...
        try:
            ...
            self.fail(
                f"full_clean raised ValidationError unexpectedly for None calculated_deposit_amount: {e.message_dict}"
            )
    ...
    def test_foreign_key_on_delete_service_type(self):
        ...
        self.assertTrue(
            TempServiceBooking.objects.filter(pk=booking_to_test.pk).exists()
        )
    ...
    def test_foreign_key_on_delete_customer_motorcycle(self):
        ...
        self.assertTrue(
            TempServiceBooking.objects.filter(pk=booking_with_motorcycle.pk).exists()
        )
