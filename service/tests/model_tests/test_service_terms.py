...
class ServiceTermsModelTest(TestCase):
    ...
    def test_deactivate_with_another_active_version_already_committed(self):
        ...
        active_terms_a = ServiceTerms.objects.create(content='Content A', is_active=True)
        active_terms_b = ServiceTerms.objects.create(content='Content B', is_active=True)
