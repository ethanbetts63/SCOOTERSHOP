...
from service.tests.test_helpers.model_factories import ServiceBookingFactory, UserFactory, PaymentFactory
...
class RejectServiceBookingTests(TestCase):
    ...
    def setUp(self):
        ...
        self.service_booking_deposit = ServiceBookingFactory(payment=PaymentFactory(amount=Decimal('50.00')), payment_status='deposit_paid', booking_status='pending')
        self.service_booking_no_deposit = ServiceBookingFactory(payment=None, payment_status='no_payment', booking_status='pending')
    ...
    def test_reject_service_booking_with_refund(self, mock_create_refund, mock_send_email):
