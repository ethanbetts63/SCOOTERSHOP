...
class AdminBookingDetailsFormTest(TestCase):
    ...
    def test_required_fields(self):
        ...
        # customer_notes, admin_notes, estimated_pickup_date are optional, so not in errors
    ...
    def test_dropoff_date_in_past_warning(self, mock_date):
        ...
        form_data = {
            'service_type': self.service_type.pk,
            'service_date': date(2025, 1, 20).strftime('%Y-%m-%d'), # Future service date
    ...
    def test_optional_fields_can_be_blank(self):
        """
        Test that optional fields (customer_notes, admin_notes, estimated_pickup_date)
        ...
        self.assertIsNone(form.cleaned_data.get('estimated_pickup_date'))
