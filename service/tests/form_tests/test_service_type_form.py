...
class AdminServiceTypeFormTest(TestCase):
    ...
    def test_form_invalid_negative_duration_days(self):
        ...
        self.assertIn('Estimated duration cannot be negative.', form.errors['estimated_duration'])
    ...
    def test_form_initialization_with_instance(self):
        ...
        self.assertEqual(form.initial['estimated_duration'], instance.estimated_duration)
