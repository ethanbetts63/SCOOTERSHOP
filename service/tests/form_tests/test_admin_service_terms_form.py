...
class AdminServiceTermsFormTest(TestCase):
    ...
    def test_valid_form_data(self):
        form = AdminServiceTermsForm(data={
            'content': 'These are some test service terms and conditions.'
        })
    ...
    def test_form_help_texts(self):
        form = AdminServiceTermsForm()
        self.assertEqual(form.fields['content'].help_text, 'This text will be displayed to customers. Saving this form will create a new, active version and archive the previous one.')