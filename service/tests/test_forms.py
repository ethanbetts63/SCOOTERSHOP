...
class BaseAdminServiceBookingFormTests(TestCase):
    ...
    # Test BaseAdminServiceBookingForm with valid data
    ...
    # Test BaseAdminServiceBookingForm with invalid data
    ...
    # Test that BaseAdminServiceBookingForm uses the correct widgets
...
class AdminAnonBookingFormTests(TestCase):
    ...
    # Test AdminAnonBookingForm with valid data
    ...
    # Test AdminAnonBookingForm with missing required data
    def test_anon_booking_form_missing_required_data(self):
        ...
        form_data = {
            ...
            'appointment_datetime': future_datetime.strftime('%Y-%m-%dT%H:%M'),
            'preferred_contact': 'email',
            # Missing one_off_first_name, one_off_last_name, one_off_email, anon_vehicle_make, anon_vehicle_model, anon_vehicle_year
        }
        form = AdminAnonBookingForm(data=form_data)
        self.assertFalse(form.is_valid())
        ...
        self.assertIn('anon_vehicle_year', form.errors)

    # Test AdminAnonBookingForm with invalid email
    ...
    # Test AdminAnonBookingForm with optional fields empty
    def test_anon_booking_form_optional_fields_empty(self):
        ...
        self.assertTrue(form.is_valid(), form.errors)
        self.assertEqual(form.cleaned_data['booking_comments'], '')
        self.assertEqual(form.cleaned_data['one_off_phone_number'], '')
        self.assertEqual(form.cleaned_data['anon_vehicle_rego'], '')
        self.assertIsNone(form.cleaned_data['anon_vehicle_odometer'])
        self.assertEqual(form.cleaned_data['anon_vehicle_transmission'], '')

    # Test that AdminAnonBookingForm uses the correct widgets
...
class AdminUserBookingFormTests(TestCase):
    ...
    # Test AdminUserBookingForm with valid data - existing motorcycle
    ...
    # Test AdminUserBookingForm with valid data - new motorcycle
    ...
    # Test that AdminUserBookingForm uses the correct widgets
