# service/utils/request_parsers.py
...
def admin_parse_booking_request_flags(request_post_data):
    ...
    create_new_profile = request_post_data.get('create_new_profile') == 'true' # Check for 'true' string
    create_new_motorcycle = request_post_data.get('create_new_motorcycle') == 'true' # Check for 'true' string
