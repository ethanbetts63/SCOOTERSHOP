                ...
                try:
                    ...
                    if refund_settings:
                        payment_obj.refund_policy_snapshot = {
                            ...
                            "cancellation_full_payment_partial_refund_percentage": float(
                                refund_settings.cancellation_full_payment_partial_refund_percentage
                            ),
                            "cancellation_full_payment_minimal_refund_days": refund_settings.cancellation_full_payment_minimal_refund_days,
                            "cancellation_full_payment_minimal_refund_percentage": float(
                                refund_settings.cancellation_full_payment_minimal_refund_percentage
                            ),
                            ...
                            "cancellation_deposit_minimal_refund_percentage": float(
                                refund_settings.cancellation_deposit_minimal_refund_percentage
                            ),
