    ...
    try:
        with transaction.atomic():
            ...
            if send_notification:
                ...
                customer_email_subject = f"Your Service Booking {booking.service_booking_reference} is Confirmed!"
                ...
                admin_email_subject = f"ADMIN: Service Booking {booking.service_booking_reference} Confirmed"
