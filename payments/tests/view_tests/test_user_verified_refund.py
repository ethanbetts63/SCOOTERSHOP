...
class UserVerifiedRefundViewTests(TestCase):
    ...
    def test_get_request_renders_correct_template_and_context(self):
        ...
        self.assertIn('reviewed by our administration team', response.context['additional_info'])
        self.assertIn('another email once your request has been processed', response.context['additional_info'])
