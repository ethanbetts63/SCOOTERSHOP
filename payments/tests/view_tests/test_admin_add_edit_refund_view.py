...
#     RefundRequestFactory, ServiceBookingFactory, SalesBookingFactory,                            
...
#     for ServiceBookings, and SalesBookings.
#     """
...
#         """
#         refund_request = RefundRequestFactory(service_booking=self.service_booking_deposit,  sales_booking=None)
...
#         """
#         refund_request = RefundRequestFactory(sales_booking=self.sales_booking_deposit, service_booking=None)
#         response = self.client.get(reverse('payments:edit_refund_request', args=[refund_request.pk]))
#         self.assertEqual(response.status_code, 200)
#         self.assertTemplateUsed(response, 'payments/admin_refund_form.html')
#         self.assertIn('form', response.context)
