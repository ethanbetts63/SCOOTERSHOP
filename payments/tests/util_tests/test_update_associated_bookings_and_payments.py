...
from payments.utils.update_associated_bookings_and_payments import (
...
class UpdateAssociatedBookingsAndPaymentsTest(TestCase):
    ...
    def test_service_booking_full_refund(self):
        ...
        update_associated_bookings_and_payments(
            payment, booking, "service_booking", Decimal("100.00")
        )
        ...
        )  # Should not change unless declined
    ...
    def test_service_booking_partial_refund(self):
        ...
        update_associated_bookings_and_payments(
            payment, booking, "service_booking", Decimal("50.00")
        )
    ...
    def test_service_booking_no_refund(self):
        ...
        update_associated_bookings_and_payments(
            payment, booking, "service_booking", Decimal("0.00")
        )
    ...
    def test_sales_booking_full_refund_from_pending(self):
        ...
        update_associated_bookings_and_payments(
            payment, booking, "sales_booking", Decimal("100.00")
        )
    ...
    def test_sales_booking_partial_refund(self):
        ...
        update_associated_bookings_and_payments(
            payment, booking, "sales_booking", Decimal("50.00")
        )
    ...
    def test_booking_obj_is_none(self):
        ...
        update_associated_bookings_and_payments(
            payment, None, "service_booking", Decimal("50.00")
        )
    ...
    def test_payment_refunded_amount_exceeds_original_amount(self):
        booking = ServiceBookingFactory(
            amount_paid=Decimal("100.00"), payment_status="paid"
        )
        payment = PaymentFactory(
            service_booking=booking,
            amount=Decimal("100.00"),
        ...
        update_associated_bookings_and_payments(
            payment, booking, "service_booking", Decimal("150.00")
        )
        ...
        )  # This will reflect the passed value
        self.assertEqual(payment.status, "refunded")
    ...
    def test_payment_status_transitions_correctly(self):
        ...
        # Partial refund
        update_associated_bookings_and_payments(
            payment, booking, "service_booking", Decimal("25.00")
        )
        payment.refresh_from_db()
        self.assertEqual(payment.status, "partially_refunded")
