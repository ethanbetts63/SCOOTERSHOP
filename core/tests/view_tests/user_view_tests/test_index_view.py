...
class IndexViewTest(TestCase):
    ...
    def setUp(self):
        ...
        patch_service_settings = patch('service.models.ServiceSettings.objects.first', return_value=self.mock_service_settings)
    ...
    def test_index_view_get(self):
        ...
        self.assertEqual(response.context['service_settings'], self.mock_service_settings)
