...
class DashboardAdminAjaxPermissionsTestCase(TestCase):
    ...
    def _test_ajax_permissions(self, url_name, kwargs=None, method='get', data=None):
        ...
        self.assertIn(response_staff.status_code, [200, 400, 500], f"URL {url} did not return 200, 400, or 500 for staff user.")
        self.client.logout()

    def test_admin_ajax_endpoints_permissions(self):
        self._test_ajax_permissions("dashboard:search_google_reviews_ajax", data={'query': 'test'})
