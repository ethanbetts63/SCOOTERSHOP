...
class HireBookingSettingsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'hire_pricing_strategy': forms.Select(attrs={'class': 'form-control'}),                                  
            'excess_hours_margin': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),                                     
            ...
            'cancellation_upfront_full_refund_days': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),
            'cancellation_upfront_partial_refund_days': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),
            'cancellation_upfront_partial_refund_percentage': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'max': '100', 'step': '0.01'}),
            'cancellation_upfront_minimal_refund_days': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),
            'cancellation_upfront_minimal_refund_percentage': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'max': '100', 'step': '0.01'}),
            ...
            'cancellation_deposit_partial_refund_percentage': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'max': '100', 'step': '0.01'}),
            'cancellation_deposit_minimal_refund_days': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),
            'cancellation_deposit_minimal_refund_percentage': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'max': '100', 'step': '0.01'}),
    ...
    def clean(self):
        ...
        min_hours = cleaned_data.get('minimum_hire_duration_hours')                                     
