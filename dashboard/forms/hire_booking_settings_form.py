...
class HireBookingSettingsForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'currency_code',
            'currency_symbol',
            # Upfront Cancellation Policy fields (renamed)
            ...
            # NEW: Deposit Cancellation Policy fields
        ...
        widgets = {
            ...
            # Upfront Cancellation Policy widgets (renamed)
            ...
            # NEW: Deposit Cancellation Policy widgets
