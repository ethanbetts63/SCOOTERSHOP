...
class BusinessInfoForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'youtube_link', 'instagram_link', 'facebook_link',
        ]
        widgets = {
            'phone_number': forms.TextInput(attrs={'class': 'form-control'}),
            'email_address': forms.EmailInput(attrs={'class': 'form-control'}),
            'street_address': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., Unit 1/123 Main St'}),
            'address_locality': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., Fremantle'}),
            'address_region': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., WA'}),
            'postal_code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., 6160'}),
            ...
            'youtube_link': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://youtube.com/your-channel'}),
            'instagram_link': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://instagram.com/your-profile'}),
            'facebook_link': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://facebook.com/your-page'}),
        }
