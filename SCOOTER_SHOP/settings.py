...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'ethanbetts.pythonanywhere.com', 'www.allbikesvespawharehouse.com.au']
...
GMB_CLIENT_ID = os.getenv('GOOGLE_API_KEY')
GMB_CLIENT_SECRET = os.getenv('GOOGLE_API_KEY')
