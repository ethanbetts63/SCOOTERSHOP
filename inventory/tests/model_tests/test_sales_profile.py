...
class SalesProfileModelTest(TestCase):
    ...
    def test_drivers_license_number_field(self):
        ...
        self.assertIsInstance(self.sales_profile_with_user.drivers_license_number, (str, type(None)))
    ...
    def test_drivers_license_expiry_field(self):
        ...
        self.assertIsInstance(self.sales_profile_with_user.drivers_license_expiry, (date, type(None)))
        self.assertTrue(field.blank)
        self.assertTrue(field.null)
        self.assertEqual(field.help_text, "Expiration date of the customer's driver's license.")

    def test_date_of_birth_field(self):
        field = self.sales_profile_with_user._meta.get_field('date_of_birth')
        self.assertIsInstance(self.sales_profile_with_user.date_of_birth, (date, type(None)))
        self.assertTrue(field.blank)
        self.assertTrue(field.null)
    ...
    def test_created_at_field(self):
        ...
        self.assertIsInstance(self.sales_profile_with_user.created_at, datetime.datetime)
        self.assertTrue(field.auto_now_add)
        self.assertEqual(field.help_text, "The date and time when this sales profile was created.")

    def test_updated_at_field(self):
        field = self.sales_profile_with_user._meta.get_field('updated_at')
        self.assertIsInstance(self.sales_profile_with_user.updated_at, datetime.datetime)
        self.assertTrue(field.auto_now)
        self.assertEqual(field.help_text, "The date and time when this sales profile was last updated.")
