...
from inventory.models.temp_sales_booking import PAYMENT_STATUS_CHOICES, BOOKING_STATUS_CHOICES
...
class TempSalesBookingModelTest(TestCase):
    ...
    def test_motorcycle_foreign_key(self):
        ...
        self.assertEqual(field.help_text, "The motorcycle associated with this temporary sales booking.")
    ...
    def test_sales_profile_foreign_key(self):
        ...
        self.assertEqual(field.help_text, "The customer's sales profile for this temporary booking.")
    ...
    def test_amount_paid_field(self):
        ...
        self.assertEqual(field.help_text, "The amount paid for this booking (e.g., deposit amount). Defaults to 0.")
    ...
    def test_payment_status_field(self):
        ...
        self.assertIn(self.temp_sales_booking.payment_status, [choice[0] for choice in PAYMENT_STATUS_CHOICES])
        self.assertEqual(field.help_text, "Current payment status of the temporary booking (e.g., unpaid, deposit_paid).")
    ...
    def test_stripe_payment_intent_id_field(self):
        ...
        self.assertIsInstance(self.temp_sales_booking.stripe_payment_intent_id, (str, type(None)))
    ...
    def test_appointment_date_field(self):
        ...
        self.assertIsInstance(self.temp_sales_booking.appointment_date, (date, type(None)))
        self.assertTrue(field.null)
        self.assertTrue(field.blank)
        self.assertEqual(field.help_text, "Requested date for the test drive or appointment.")

    def test_appointment_time_field(self):
        field = self.temp_sales_booking._meta.get_field('appointment_time')
        self.assertIsInstance(self.temp_sales_booking.appointment_time, (time, type(None)))
        self.assertTrue(field.null)
        self.assertTrue(field.blank)
        self.assertEqual(field.help_text, "Requested time for the test drive or appointment.")
    ...
    def test_customer_notes_field(self):
        ...
        self.assertTrue(field.blank)
        self.assertTrue(field.null)
        self.assertEqual(field.help_text, "Any additional notes or messages provided by the customer during the process.")
    ...
    def test_created_at_field(self):
        ...
        self.assertEqual(field.help_text, "The date and time when this temporary booking was created.")
    ...
    def test_updated_at_field(self):
        ...
        self.assertEqual(field.help_text, "The date and time when this temporary booking was last updated.")
