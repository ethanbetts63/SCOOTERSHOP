...
class BookingAppointmentFormTest(TestCase):
    ...
    def test_valid_form_data(self):
        form = BookingAppointmentForm(data={
    ...
    def test_terms_not_accepted(self):
        ...
        self.assertIn('You must accept the terms and conditions.', form.errors['terms_accepted'])
    ...
    def test_appointment_date_min_max_attributes(self):
        ...
        min_date = date.today() + timedelta(hours=self.mock_inventory_settings.min_advance_booking_hours)
        max_date = date.today() + timedelta(days=self.mock_inventory_settings.max_advance_booking_days)
        self.assertEqual(form.fields['appointment_date'].widget.attrs['min'], min_date.strftime("%Y-%m-%d"))
        self.assertEqual(form.fields['appointment_date'].widget.attrs['max'], max_date.strftime("%Y-%m-%d"))
