...
class AdminSalesfaqFormTest(TestCase):
    ...
    def test_form_widgets(self):
        form = AdminSalesfaqForm()
        self.assertEqual(form.fields['booking_step'].widget.attrs['class'], 'form-control')
        ...
        self.assertEqual(form.fields['display_order'].widget.attrs['class'], 'form-control')
        self.assertEqual(form.fields['is_active'].widget.attrs['class'], 'form-checkbox')
