...
class AdminSalesTermsFormTest(TestCase):
    ...
    def test_valid_form_data(self):
        form = AdminSalesTermsForm(data={
            'content': 'These are some test terms and conditions.'
        })
    ...
    def test_form_help_texts(self):
        form = AdminSalesTermsForm()
        self.assertEqual(form.fields['content'].help_text, 'This text will be displayed to customers during the booking process. Saving this form will create a new, active version and archive the previous one.')