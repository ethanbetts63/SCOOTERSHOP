...
class InventorySettingsFormTest(TestCase):
    ...
    def test_negative_deposit_amount(self):
        ...
        self.assertEqual(
            form.errors["deposit_amount"], ["Deposit amount cannot be negative."]
        )
    ...
    def test_negative_deposit_lifespan_days(self):
        ...
        self.assertEqual(
            form.errors["deposit_lifespan_days"],
    ...
    def test_start_time_after_end_time(self):
        ...
        self.assertEqual(
            form.errors["sales_appointment_start_time"],
            ["Appointment start time must be earlier than end time."],
        )
        self.assertEqual(
            form.errors["sales_appointment_end_time"],
    ...
    def test_non_positive_appointment_spacing(self):
        ...
        self.assertEqual(
            form.errors["sales_appointment_spacing_mins"],
    ...
    def test_negative_max_advance_booking_days(self):
        ...
        self.assertEqual(
            form.errors["max_advance_booking_days"],
    ...
    def test_negative_min_advance_booking_hours(self):
        ...
        self.assertEqual(
            form.errors["min_advance_booking_hours"],
