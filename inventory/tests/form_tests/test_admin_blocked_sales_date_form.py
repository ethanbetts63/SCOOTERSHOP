...
class AdminBlockedSalesDateFormTest(TestCase):
    ...
    def test_valid_form_data(self):
        form = AdminBlockedSalesDateForm(data={
    ...
    def test_form_widgets(self):
        form = AdminBlockedSalesDateForm()
        self.assertEqual(form.fields['start_date'].widget.attrs['class'], 'form-control flatpickr-admin-date-input')
        self.assertEqual(form.fields['end_date'].widget.attrs['class'], 'form-control flatpickr-admin-date-input')
    ...
    def test_form_help_texts(self):
        form = AdminBlockedSalesDateForm()
        self.assertEqual(form.fields['start_date'].help_text, 'The first date of the blocked period.')
        self.assertEqual(form.fields['end_date'].help_text, 'The last date of the blocked period (inclusive).')
        self.assertEqual(form.fields['description'].help_text, 'A brief note about why these dates are blocked (e.g., \'Public Holiday\', \'Staff Leave\').')