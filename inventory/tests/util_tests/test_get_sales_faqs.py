...
class GetSalesFaqsTest(TestCase):
    def setUp(self):
        ...
        self.faq_step1_1 = SalesfaqFactory(
            booking_step="step1", display_order=1, is_active=True
        )
        self.faq_step1_2 = SalesfaqFactory(
            booking_step="step1", display_order=2, is_active=True
        )
        self.faq_step2_1 = SalesfaqFactory(
            booking_step="step2", display_order=1, is_active=True
        )
        self.faq_general_1 = SalesfaqFactory(
            booking_step="general", display_order=1, is_active=True
        )
        self.faq_general_2 = SalesfaqFactory(
            booking_step="general", display_order=2, is_active=True
        )
        self.faq_inactive = SalesfaqFactory(
            booking_step="step1", display_order=3, is_active=False
        )
