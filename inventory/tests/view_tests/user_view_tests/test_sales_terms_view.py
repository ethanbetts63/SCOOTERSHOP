...
class SalesTermsViewTest(TestCase):
    ...
    def test_sales_terms_view_get_multiple_active_terms(self):
        ...
        active_terms1 = SalesTermsFactory(is_active=True, content='First Active', version_number=1)
        active_terms2 = SalesTermsFactory(is_active=True, content='Second Active', version_number=2)
        ...
        self.assertTrue('First Active' in response.content.decode() or 'Second Active' in response.content.decode())
