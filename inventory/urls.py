...
urlpatterns = [
    ...
    path(
        ...
        step1_sales_profile.Step1SalesProfileView.as_view(),
        name="step1_sales_profile",
    ),
    path(
        "booking/details-and-appointment/",
        step2_booking_details.Step2BookingDetailsView.as_view(),
        name="step2_booking_details_and_appointment",
    ),
    path(
        "booking/payment/",
        step3_payment_view.Step3PaymentView.as_view(),
        name="step3_payment",
    ),
    path(
    ...
    path(
        ...
        inventory_management_view.InventoryManagementView.as_view(),
        {"condition_slug": "new"},
        name="admin_new_motorcycle_management",
    ),
    path(
        "admin/inventory/used/",
        inventory_management_view.InventoryManagementView.as_view(),
        {"condition_slug": "used"},
        name="admin_used_motorcycle_management",
    ),
    path(
        "admin/motorcycles/create/",
        motorcycle_create_update_view.MotorcycleCreateUpdateView.as_view(),
        name="admin_motorcycle_create",
    ),
    path(
        "admin/motorcycles/<int:pk>/update/",
        motorcycle_create_update_view.MotorcycleCreateUpdateView.as_view(),
        name="admin_motorcycle_update",
    ),
    path(
        "admin/motorcycles/<int:pk>/delete/",
        delete_motorcycle.MotorcycleDeleteView.as_view(),
        name="admin_motorcycle_delete",
    ),
    path(
        "admin/motorcycles/<int:pk>/details/",
    ...
    path(
        ...
        name="sales_bookings_management",
    ),
    path(
        "admin/sales-bookings/create/",
        sales_booking_create_update_view.SalesBookingCreateUpdateView.as_view(),
        name="sales_booking_create",
    ),
    path(
        "admin/sales-bookings/<int:pk>/update/",
        sales_booking_create_update_view.SalesBookingCreateUpdateView.as_view(),
        name="sales_booking_update",
    ),
    path(
        "admin/sales-bookings/<int:pk>/delete/",
        delete_sales_booking.SalesBookingDeleteView.as_view(),
        name="admin_sales_booking_delete",
    ),
    path(
        "admin/sales-bookings/<int:pk>/details/",
        sales_booking_details_view.SalesBookingDetailsView.as_view(),
        name="sales_booking_details",
    ),
    path(
        "admin/sales-bookings/<int:pk>/<str:action_type>/",
    ...
    path(
        ...
        name="sales_profile_management",
    ),
    path(
        "admin/sales-profiles/create/",
        sales_profile_create_update_view.SalesProfileCreateUpdateView.as_view(),
        name="sales_profile_create",
    ),
    path(
        "admin/sales-profiles/<int:pk>/update/",
        sales_profile_create_update_view.SalesProfileCreateUpdateView.as_view(),
        name="sales_profile_update",
    ),
    path(
        "admin/sales-profiles/<int:pk>/delete/",
        delete_sales_profile.SalesProfileDeleteView.as_view(),
        name="admin_sales_profile_delete",
    ),
    path(
        "admin/sales-profiles/<int:pk>/details/",
    ...
    path(
        "ajax/get_appointment_times/",
        get_available_appointment_times_for_date,
        name="ajax_get_appointment_times",
    ),
    path(
        "ajax/payment-status-check/",
        ajax_get_payment_status.GetPaymentStatusView.as_view(),
        name="ajax_sales_payment_status_check",
    ),
    path(
        "ajax/sales-booking-details/<int:pk>/",
        ajax_get_sales_booking_details.get_sales_booking_details_json,
        name="api_sales_booking_details",
    ),
    path(
        "ajax/admin/search-motorcycles/",
        ajax_search_motorcycles.search_motorcycles_ajax,
        name="admin_api_search_motorcycles",
    ),
    path(
        "ajax/admin/get-motorcycle-details/<int:pk>/",
        ajax_get_motorcycle_details.get_motorcycle_details_ajax,
        name="admin_api_get_motorcycle_details",
    ),
    path(
        "ajax/admin/search-sales-profiles/",
        ajax_search_sales_profiles.search_sales_profiles_ajax,
        name="admin_api_search_sales_profiles",
    ),
    path(
        "ajax/admin/get-sales-profile-details/<int:pk>/",
        ajax_get_sales_profile_details.get_sales_profile_details_ajax,
        name="admin_api_get_sales_profile_details",
    ),
    path(
        "ajax/admin/sales-booking-precheck/",
        ajax_sales_booking_precheck.sales_booking_precheck_ajax,
        name="admin_api_sales_booking_precheck",
    ),
    path(
