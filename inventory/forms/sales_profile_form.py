...
class SalesProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'drivers_license_image': forms.ClearableFileInput(attrs={'class': 'mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-md cursor-pointer bg-gray-50 focus:outline-none'}),                             
