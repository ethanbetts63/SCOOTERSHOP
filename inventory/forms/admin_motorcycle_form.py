...
class MotorcycleForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "status": forms.Select(
                attrs={
                    "class": "form-select mt-1 block w-full rounded-md border border-gray-300 shadow-sm text-gray-900"
                }
            ),
            ...
            "description": forms.Textarea(
                attrs={
                    "class": "form-textarea mt-1 block w-full rounded-md border border-gray-300 shadow-sm text-gray-900"
                }
            ),
            ...
            "conditions": forms.CheckboxSelectMultiple(
                attrs={"class": "condition-checkbox-list"}
            ),
        }
