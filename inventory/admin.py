...
class MotorcycleResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            'id', 'stock_number', 'vin_number', 'brand', 'model', 'year', 'price',
            'condition', 'status', 'meta_title',
        )
        export_order = fields
...
class SalesBookingResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            'id', 'sales_booking_reference', 'sales_profile', 'motorcycle',
            'booking_status', 'payment_status', 'payment_method',
            'customer_notes', 'calculated_total', 'amount_paid',
        )
        export_order = fields
...
class MotorcycleAdmin(ImportExportModelAdmin):
    ...
    list_display = ('stock_number', 'brand', 'model', 'year', 'price', 'condition', 'status')
...
class SalesBookingAdmin(ImportExportModelAdmin):
    ...
    list_display = ('sales_booking_reference', 'motorcycle', 'sales_profile', 'booking_status', 'payment_status')
    list_filter = ('booking_status', 'payment_status')
    search_fields = ('sales_booking_reference', 'sales_profile__name', 'sales_profile__email', 'motorcycle__stock_number')
