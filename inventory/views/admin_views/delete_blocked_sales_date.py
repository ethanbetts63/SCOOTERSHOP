# SCOOTER_SHOP/inventory/views/admin_views/blocked_sales_date_delete_view.py
...
class BlockedSalesDateDeleteView(AdminRequiredMixin, View):
    def post(self, request, pk, *args, **kwargs):
        ...
        try:
            blocked_date.delete()
            messages.success(request, f'Blocked sales date {blocked_date} deleted successfully!')
