...
def get_sales_profile_details_ajax(request, pk):
    ...
    profile_details = {
        ...
        'drivers_license_expiry': str(sales_profile.drivers_license_expiry) if sales_profile.drivers_license_expiry else None,                         
        'date_of_birth': str(sales_profile.date_of_birth) if sales_profile.date_of_birth else None,                         
