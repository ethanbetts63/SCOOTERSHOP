...
def create_or_update_sales_payment_intent(
        ...
        try:
            ...
            if retrieved_intent:
                ...
                if (
                    ...
                    stripe_intent = stripe.PaymentIntent.modify(
                        ...
                        metadata={
                            ...
                            "sales_profile_id": (
                                str(sales_profile.id) if sales_profile else "guest"
                            ),
                    ...
                    not is_modifiable_or_in_progress
                    and retrieved_intent.status != "succeeded"
                ):
                    stripe_intent = None
                    django_payment_obj = None
                ...
                if (
                    django_payment_obj
                    and stripe_intent
                    and django_payment_obj.status != stripe_intent.status
                ):
    ...
    if not stripe_intent:
        ...
        django_payment_obj
        and django_payment_obj.stripe_payment_intent_id != stripe_intent.id
    ):
        pass
