...
def reject_sales_booking(
    sales_booking_id, requesting_user=None, form_data=None, send_notification=True
):
        ...
        with transaction.atomic():
            ...
            if original_booking_status not in [
                ...
                if (
                    ...
                    created_refund_req = create_refund_request(
                        ...
                        reason=f"Sales Booking {booking.sales_booking_reference} rejected by admin."
            ...
            if send_notification and not refund_request_created:
                ...
                customer_email_subject = (
                    f"Update Regarding Your Sales Booking for {motorcycle.title}"
                )
                ...
                admin_email_subject = (
                    f"ADMIN: Sales Booking {booking.sales_booking_reference} Rejected"
                )
