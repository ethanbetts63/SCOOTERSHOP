...
urlpatterns = [
    ...
    path('book/step2/choose-bike/', views.HireMotorcycleListView.as_view(), name='step2_choose_bike'),
    path('book/step3/', views.AddonPackageView.as_view(), name='step3_addons_packages'),
