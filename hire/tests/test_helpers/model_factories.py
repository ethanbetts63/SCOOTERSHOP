...
def create_hire_settings(
    ...
    settings, created = HireSettings.objects.get_or_create(pk=1)                              
...
def create_booking_addon(
    ...
    if booked_addon_price is None:
        booked_addon_price = addon.daily_cost * quantity                                   
...
def create_temp_hire_booking(
    ...
    if motorcycle and not booked_hourly_rate:             
        booked_hourly_rate = motorcycle.hourly_hire_rate             

                                                                                      
    if package and total_package_price is None:
        total_package_price = package.daily_cost                                                     
