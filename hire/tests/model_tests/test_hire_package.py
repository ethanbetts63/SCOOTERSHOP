...
class PackageModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        """
        cls.addon1 = create_addon(name="GPS Device", cost=Decimal('15.00'))
        cls.addon2 = create_addon(name="Riding Jacket", cost=Decimal('25.00'))
    ...
    def test_create_basic_package(self):
        ...
        self.assertEqual(package.package_price, Decimal('150.00'))
    ...
    def test_add_ons_relationship(self):
        ...
        addon3 = create_addon(name="Gloves", cost=Decimal('10.00'))
    ...
    def test_clean_negative_package_price_raises_error(self):
        ...
        """
        package = create_package(name="Invalid Price Package", package_price=Decimal('-10.00'))
        with self.assertRaises(ValidationError) as cm:
            package.clean()
        self.assertIn('package_price', cm.exception.message_dict)
        self.assertEqual(cm.exception.message_dict['package_price'][0], "Package price cannot be negative.")
