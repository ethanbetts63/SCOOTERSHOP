...
class ProcessRefundRequestEntryTestCase(TestCase):
    ...
    def test_create_new_refund_request_for_service_booking(self):
        ...
        refund_request = process_refund_request_entry(
            payment, service_booking, "service_booking", extracted_data
        )
    ...
    def test_update_existing_unverified_refund_request(self):
        ...
        updated_refund_request = process_refund_request_entry(
            payment, service_booking, "service_booking", extracted_data
        )
        ...
        self.assertEqual(
            updated_refund_request.stripe_refund_id, "re_updated_unverified_789"
        )
    ...
    def test_no_booking_linked_to_payment(self):
        ...
        refund_request = process_refund_request_entry(
            payment, None, "unknown", extracted_data
        )
