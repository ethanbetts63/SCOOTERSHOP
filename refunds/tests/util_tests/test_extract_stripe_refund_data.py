...
class ExtractStripeRefundDataTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.mock_now_patch = mock.patch(
    ...
    @mock.patch("stripe.Charge.retrieve")
    def test_extract_from_charge_object_partial_refund(
        self, mock_stripe_charge_retrieve
    ):
        ...
        mock_retrieved_charge.refunds = mock.Mock(
            data=[
                ...
                },
                {
                    ...
                    "status": "succeeded",
                    "amount": 2000,
                    "created": latest_refund_time.timestamp(),
                },
            ]
        )
    ...
    @mock.patch("stripe.Charge.retrieve")
    def test_extract_from_refund_object_with_charge_retrieve(
        self, mock_stripe_charge_retrieve
    ):
    ...
    @mock.patch(
        ...
        side_effect=stripe.error.StripeError("Charge not found"),
    )
    def test_extract_from_refund_object_charge_retrieve_fails(
        self, mock_stripe_charge_retrieve
    ):
    ...
    @mock.patch("stripe.Charge.retrieve")
    def test_extract_from_charge_object_amount_refunded_none(
        self, mock_stripe_charge_retrieve
    ):
    ...
    @mock.patch("stripe.Charge.retrieve")
    def test_extract_from_refund_object_charge_retrieve_amount_refunded_none(
        self, mock_stripe_charge_retrieve
    ):
