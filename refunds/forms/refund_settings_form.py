...
class RefundSettingsForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "full_payment_full_refund_days": _("Full Payment: Full Refund Days"),
            "full_payment_partial_refund_days": _("Full Payment: Partial Refund Days"),
            "full_payment_partial_refund_percentage": _(
                "Full Payment: Partial Refund Percentage (%)"
            ),
            "full_payment_no_refund_percentage": _("Full Payment: No Refund Days"),
            "deposit_full_refund_days": _("Deposit: Full Refund Days"),
            "deposit_partial_refund_days": _("Deposit: Partial Refund Days"),
            "deposit_partial_refund_percentage": _(
                "Deposit: Partial Refund Percentage (%)"
            ),
            "deposit_no_refund_days": _("Deposit: No Refund Days"),
        }
        help_texts = {
    ...
    def clean(self):
        ...
        try:
            instance = (
                self.instance if self.instance.pk else RefundSettings(**cleaned_data)
            )
