...
def calculate_sales_refund_amount(booking, cancellation_datetime: datetime = None) -> dict:
    ...
    elif days_since_booking >= refund_settings.deposit_no_refund_days:
        entitled_amount = Decimal("0.00")
        policy_applied = f"No Refund ({refund_settings.deposit_no_refund_days} or more days since booking)"
